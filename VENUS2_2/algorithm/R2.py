...
class Droid:
    def __init__(self, start, direction, venusMap, name = 'R2'):
        self.name = name 
    ...
    def update(self, long_dist, hit_fatal):
        ...
        if self.state == 'scanning':
            ...
            self.state = 'planning_sweep'
        self.Pos[0] += self.speed/30000 * self.direction[0]
        self.Pos[1] += self.speed/30000 * self.direction[1]
...
def main():
    ...
    sensor.setsockopt(zmq.CONFLATE, 1)
...
#    WallE_loc.set(zmq.SUBSCRIBE, b"")
    ...
    venus_map = venusMap()
    R2        = Droid([0, 40], [0, 1], venus_map, name="R2")
...
#            pass
        ...
        if valid:
            #print('trying to update algorithm')
